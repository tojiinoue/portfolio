...
const experiences = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "cc-sddやkiroにより、仕様駆動開発を実施。既存コードから仕様書を自動生成・更新する仕組みを確立。NotebookLMを活用した案件内QAチャットを構築し、情報参照の属人化を抑制。",
...
const businessExperiences = [
  ...
  },
  {
    ...
    period: "大学時代",
    desc: "企業のSNSコンサルティング、YouTube/TikTokの動画編集スキルを活かしたチームの組織化・ディレクションを経験。",
    icon: "🎬",
    color: "#e3b341",
  },
  {
    title: "インサイドセールス・フィールドセールス",
    period: "大学時代",
    desc: "採用支援サービスの営業として、インサイドセールスとフィールドセールスの両方を経験。顧客獲得のフロント業務を通じて、エンジニアになる前のビジネス経験として顧客視点を養った。",
    icon: "📞",
    color: "#3fb950",
  },
  {
    title: "飲食・小売アルバイト",
    period: "高校〜大学",
    desc: "ファミレス、回転寿司、スーパー品出し、イタリアン、焼肉屋など多様な現場でサービス業の基礎を習得。",
    icon: "🍽️",
    color: "#58a6ff",
  },
];
