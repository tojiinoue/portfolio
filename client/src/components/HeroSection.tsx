    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <motion.div initial="hidden" animate="visible" variants={heroStagger}>
          ...
          {/* Description */}
          <motion.div className="max-w-2xl mb-10" variants={fadeUp}>
            <p className="text-[#8b949e] text-base sm:text-lg leading-relaxed font-sans">
              AI駆動開発 ×
              仕様駆動開発で手戻りゼロの開発現場をつくるバックエンドエンジニア。
              <br />
          ...
          {/* Stats */}
          <motion.div className="flex flex-wrap gap-6 mb-10" variants={fadeUp}>
            {[
